...
if __name__ == '__main__':
    ...
    parser.add_argument('-m',
                        ...
                        required=False,
                        default='yolov7',
                        help='Inference models name, default yolov7')
    parser.add_argument('--width',
                        type=int,
                        required=False,
                        default=640,
                        help='Inference models input width, default 640')
    parser.add_argument('--height',
                        type=int,
                        required=False,
                        default=640,
                        help='Inference models input height, default 640')
    ...
    parser.add_argument('-i',
                        ...
                        required=False,
                        default=False,
                        help='Print models status, configuration and statistics')
    ...
    if FLAGS.model_info:
        ...
        try:
            ...
            if "Request for unknown models" not in ex.message():
