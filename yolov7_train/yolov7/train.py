...
global_results_file = None


def train(hyp, opt, device, tb_writer=None):
    global global_results_file
    ...
    global_results_file = results_file
    ...
    destination_path = Path("C:/Users/Admin/Desktop/Yolov7_Mimi/yolov7_train/yolov7/results.txt")
